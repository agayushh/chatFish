  ...
  return (
    <div>
      <div className="bg-gradient-to-tl from-black via-slate-800 to-slate-900 h-screen w-screen flex items-center justify-center flex-wrap">
        <div className="border-white/20 border-2 backdrop-blur-sm bg-black/30 rounded-xl h-[70vh] w-[35vw] p-8 shadow-lg shadow-black/50 hover:border-white/40 transition-all duration-300">
          <h1 className="text-white text-4xl font-mono font-bold tracking-wider">ChatFish</h1>
          <br />
          <span className="text-white/90 text-xl font-semibold">Create a Room</span>
